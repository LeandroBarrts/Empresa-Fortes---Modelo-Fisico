...
ID_USUARIO VARCHAR(45) PRIMARY KEY,
NOME VARCHAR(45) NOT NULL,
...
CONSTRAINT USU_FUNCI FOREIGN KEY (CPF, ID_FUNCIONARIO) REFERENCES FUNCIONARIOS (CPF, ID_FUNCIONARIO),
CONSTRAINT USU_INSTI FOREIGN KEY (ID_INSTITUICAO, CNPJ) REFERENCES INSTITUICAO (ID_INSTITUICAO, CNPJ));

CREATE TABLE IF NOT EXISTS FUNCIONARIOS_HAS_ARQUIVOS(
CPF CHAR(15) PRIMARY KEY,
ID_FUNCIONARIO VARCHAR(45) PRIMARY KEY,
ID_ARQUIVO INT PRIMARY KEY,
CONSTRAINT FUNCI_HAS_ARQ FOREIGN KEY (CPF, ID_FUNCIONARIO) REFERENCES FUNCIONARIOS (CPF, ID_FUNCIONARIO),
CONSTRAINT FUNCI_HAS_ARQ FOREIGN KEY (ID_ARQUIVO) REFERENCES ARQUIVOS (ID_ARQUIVO));
